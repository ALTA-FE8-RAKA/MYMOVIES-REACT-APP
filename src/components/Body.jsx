        ...
        <div className="bg-white dark:bg-gray-800 py-6 sm:py-8 lg:py-12">
          <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
            <div className="flex justify-between items-end gap-4 mb-6">
              ...
              <a
                href={url}
                className="inline-block text-gray-800 dark:text-white bg-white dark:bg-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 focus-visible:ring ring-indigo-300 border text-gray-500 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-4 md:px-8 py-2 md:py-3"
              >
                Show more
              </a>
            </div>
